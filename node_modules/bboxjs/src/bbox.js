...
BBoxSelector = (function () {
    function BBoxSelector(frame, options) {
        ...
        options.ids.rectangle !== undefined ||
            (options.ids.rectangle =
                options.prefix + 'bbox-selector-rectangle')
        options.ids.diagonal !== undefined ||
            (options.ids.diagonal =
                options.prefix + 'bbox-selector-diagonal')
        options.colors !== undefined || (options.colors = {})
        options.colors.subentry !== undefined ||
            (options.colors.subentry = '#444444')
        options.border !== undefined || (options.border = {})
        options.border.color !== undefined ||
            (options.border.color = '#7FFF7F')
        options.border.width !== undefined ||
            (options.border.width = 2)
        options.limits.bounds !== undefined ||
            (options.limits.bounds = {})
        options.limits.bounds.x !== undefined ||
            (options.limits.bounds.x = {})
        options.limits.bounds.x.min !== undefined ||
            (options.limits.bounds.x.min = 0)
        options.limits.bounds.x.max !== undefined ||
            (options.limits.bounds.x.max = 0)
        options.limits.bounds.y !== undefined ||
            (options.limits.bounds.y = {})
        options.limits.bounds.y.min !== undefined ||
            (options.limits.bounds.y.min = 0)
        options.limits.bounds.y.max !== undefined ||
            (options.limits.bounds.y.max = 0)
        options.modes !== undefined ||
            (options.modes = ['rectangle', 'diagonal', 'diagonal2'])
    ...
    BBoxSelector.prototype.create_selector_elements = function (
        frame,
    ) {
        ...
        this.elements.rectangle = $(
            '<div id="' + this.options.ids.rectangle + '"></div>',
        )
        ...
        this.elements.diagonal = $(
            '<div id="' + this.options.ids.diagonal + '"></div>',
        )
        ...
        switch (proposed_mode) {
            ...
            case 'diagonal2':
                if (this.options.modes.indexOf(proposed_mode) == -1) {
                    console.log(
                        '[BBoxSelector] User disabled selection mode provided: ' +
                            proposed_mode,
                    )
                } else {
            ...
            default:
                console.log(
                    '[BBoxSelector] Invalid selection mode provided: ' +
                        proposed_mode,
                )
        }
    ...
    BBoxSelector.prototype.check_boundaries = function (event) {
        ...
        point.x = Math.min(
            point.x,
            this.elements.frame.width() - 1 + bounds.x.max,
        )
        point.y = Math.min(
            point.y,
            this.elements.frame.height() - 1 + bounds.y.max,
        )
        return point
    }
    ...
    BBoxSelector.prototype.get_selector_data = function (event) {
        ...
        data.pixels.xtl = Math.min(
            data.pixels.origin.x,
            data.pixels.middle.x,
        )
        data.pixels.ytl = Math.min(
            data.pixels.origin.y,
            data.pixels.middle.y,
        )
        data.pixels.xbr = Math.max(
            data.pixels.origin.x,
            data.pixels.middle.x,
        )
        data.pixels.ybr = Math.max(
            data.pixels.origin.y,
            data.pixels.middle.y,
        )
        ...
        data.pixels.hypo = Math.sqrt(
            Math.pow(data.pixels.width, 2) +
                Math.pow(data.pixels.height, 2),
        )
        diff_x = data.pixels.middle.x - data.pixels.cursor.x
        diff_y = data.pixels.middle.y - data.pixels.cursor.y
        data.pixels.right = Math.sqrt(
            Math.pow(diff_x, 2) + Math.pow(diff_y, 2),
        )

        data.angles.origin = calculate_angle(
            data.pixels.origin,
            data.pixels.middle,
        )
        data.angles.middle = calculate_angle(
            data.pixels.middle,
            data.pixels.cursor,
        )
        ...
        if (this.options.mode == 'rectangle') {
            ...
            if (this.current_stage > 0) {
                ...
                data.pixels.correction = {
                    x:
                        Math.cos(data.angles.right) *
                        data.pixels.adjacent,
                    y:
                        Math.sin(data.angles.right) *
                        data.pixels.adjacent,
                }
            ...
            centers.rect = {
                x:
                    data.pixels.xtl +
                    this.elements.rectangle.width() * 0.5,
                y:
                    data.pixels.ytl +
                    this.elements.rectangle.height() * 0.5,
            }
        ...
        if (this.options.mode == 'rectangle') {
            ...
            if (this.current_stage == 0) {
                ...
                this.elements.rectangle.css({
                    top:
                        data.pixels.origin.y +
                        data.pixels.correction.y +
                        'px',
                    left:
                        data.pixels.origin.x +
                        data.pixels.correction.x +
                        'px',
                    width: data.pixels.hypo + 'px',
...
this.BBoxAnnotator = (function () {
    function BBoxAnnotator(url, options) {
        ...
        options.prefix !== undefined || (options.prefix = '')
        options.ids !== undefined || (options.ids = {})
        options.ids.container !== undefined ||
            (options.ids.container =
                options.prefix + 'bbox-annotator-container')
        options.ids.resize !== undefined ||
            (options.ids.resize =
                options.prefix + 'bbox-annotator-bbox-resize')
        options.props !== undefined || (options.props = {})
        options.props.rotate !== undefined ||
            (options.props.rotate =
                options.prefix + 'bbox-annotator-bbox-rotate-handle')
        options.props.resize !== undefined ||
            (options.props.resize =
                options.prefix + 'bbox-annotator-bbox-resize-handle')
        options.classes !== undefined || (options.classes = {})
        options.classes.bbox !== undefined ||
            (options.classes.bbox =
                options.prefix + 'bbox-annotator-bbox')
        options.classes.assignment !== undefined ||
            (options.classes.assignment =
                options.prefix + 'bbox-annotator-bbox-assignment')
        options.classes.label !== undefined ||
            (options.classes.label =
                options.prefix + 'bbox-annotator-bbox-label')
        options.classes.close !== undefined ||
            (options.classes.close =
                options.prefix + 'bbox-annotator-bbox-close')
        options.classes.rotate !== undefined ||
            (options.classes.rotate =
                options.prefix + 'bbox-annotator-bbox-rotate')
        options.classes.resize !== undefined ||
            (options.classes.resize =
                options.prefix + 'bbox-annotator-bbox-resize')
        options.colors !== undefined || (options.colors = {})
        options.colors.default !== undefined ||
            (options.colors.default = '#7FFF7F')
        options.colors.hover !== undefined ||
            (options.colors.hover = '#F0AD4E')
        options.colors.focus !== undefined ||
            (options.colors.focus = '#EB2A18')
        options.colors.anchor !== undefined ||
            (options.colors.anchor = '#EB2A18')
        options.colors.subentry !== undefined ||
            (options.colors.subentry = '#444444')
        options.colors.highlighted !== undefined ||
            (options.colors.highlighted = '#2E63FF')
        options.colors.transparent !== undefined ||
            (options.colors.transparent = 0.25)
        options.actions !== undefined || (options.actions = {})
        options.actions.entry !== undefined ||
            (options.actions.entry = {})
        options.actions.entry.addition !== undefined ||
            (options.actions.entry.addition = true)
        options.actions.entry.parts !== undefined ||
            (options.actions.entry.parts = true)
        options.actions.entry.translation !== undefined ||
            (options.actions.entry.translation = true)
        options.actions.entry.scaling !== undefined ||
            (options.actions.entry.scaling = true)
        options.actions.entry.rotation !== undefined ||
            (options.actions.entry.rotation = true)
        options.actions.entry.deletion !== undefined ||
            (options.actions.entry.deletion = true)
        options.actions.subentry !== undefined ||
            (options.actions.subentry = {})
        options.actions.subentry.addition !== undefined ||
            (options.actions.subentry.addition = true)
        options.actions.subentry.parts !== undefined ||
            (options.actions.subentry.parts = true)
        options.actions.subentry.translation !== undefined ||
            (options.actions.subentry.translation = true)
        options.actions.subentry.scaling !== undefined ||
            (options.actions.subentry.scaling = true)
        options.actions.subentry.rotation !== undefined ||
            (options.actions.subentry.rotation = true)
        options.actions.subentry.deletion !== undefined ||
            (options.actions.subentry.deletion = true)
        options.hotkeys !== undefined || (options.hotkeys = {})
        options.hotkeys.enabled !== undefined ||
            (options.hotkeys.enabled = true)
        options.hotkeys.delete !== undefined ||
            (options.hotkeys.delete = [8, 46, 75]) // 46 for Firefox
        options.hotkeys.exit !== undefined ||
            (options.hotkeys.exit = [27])
        options.hotkeys.zoom !== undefined ||
            (options.hotkeys.zoom = [90])
        options.hotkeys.background !== undefined ||
            (options.hotkeys.background = [66])
        options.hotkeys.focus !== undefined ||
            (options.hotkeys.focus = [70])
        options.hotkeys.counterclockwise !== undefined ||
            (options.hotkeys.counterclockwise = [76])
        options.hotkeys.clockwise !== undefined ||
            (options.hotkeys.clockwise = [82])
        options.hotkeys.left !== undefined ||
            (options.hotkeys.left = [37])
        options.hotkeys.up !== undefined ||
            (options.hotkeys.up = [38])
        options.hotkeys.right !== undefined ||
            (options.hotkeys.right = [39])
        options.hotkeys.down !== undefined ||
            (options.hotkeys.down = [40])
        options.handles !== undefined || (options.handles = {})
        options.handles.rotate !== undefined ||
            (options.handles.rotate = {})
        options.handles.rotate.enabled !== undefined ||
            (options.handles.rotate.enabled = true)
        options.handles.rotate.diameter !== undefined ||
            (options.handles.rotate.diameter = 10)
        options.handles.resize !== undefined ||
            (options.handles.resize = {})
        options.handles.resize.enabled !== undefined ||
            (options.handles.resize.enabled = true)
        options.handles.resize.diameter !== undefined ||
            (options.handles.resize.diameter = 8)
        options.handles.close !== undefined ||
            (options.handles.close = {})
        options.handles.close.enabled !== undefined ||
            (options.handles.close.enabled = false)
        options.border !== undefined || (options.border = {})
        options.border.color !== undefined ||
            (options.border.color = options.colors.default)
        options.border.width !== undefined ||
            (options.border.width = 2)
        options.steps !== undefined || (options.steps = {})
        options.steps.move !== undefined ||
            (options.steps.move = 10.0)
        options.steps.rotate !== undefined ||
            (options.steps.rotate = Math.PI / 4.0)
        options.subentries !== undefined || (options.subentries = {})
        options.subentries.visible !== undefined ||
            (options.subentries.visible = null)
        options.subentries.assignments !== undefined ||
            (options.subentries.assignments = false)
        options.subentries.label !== undefined ||
            (options.subentries.label = true)
        options.limits !== undefined || (options.limits = {})
        options.limits.frame !== undefined ||
            (options.limits.frame = {})
        options.limits.frame.width !== undefined ||
            (options.limits.frame.width = 1000)
        options.limits.frame.height !== undefined ||
            (options.limits.frame.height = 700)
        options.limits.entry !== undefined ||
            (options.limits.entry = {})
        options.limits.entry.area !== undefined ||
            (options.limits.entry.area = 100)
        options.limits.entry.width !== undefined ||
            (options.limits.entry.width = 10)
        options.limits.entry.height !== undefined ||
            (options.limits.entry.height = 10)
        options.limits.bounds !== undefined ||
            (options.limits.bounds = {})
        options.limits.bounds.x !== undefined ||
            (options.limits.bounds.x = {})
        options.limits.bounds.x.min !== undefined ||
            (options.limits.bounds.x.min = 50)
        options.limits.bounds.x.max !== undefined ||
            (options.limits.bounds.x.max = 50)
        options.limits.bounds.y !== undefined ||
            (options.limits.bounds.y = {})
        options.limits.bounds.y.min !== undefined ||
            (options.limits.bounds.y.min = 50)
        options.limits.bounds.y.max !== undefined ||
            (options.limits.bounds.y.max = 50)
        options.confirm !== undefined || (options.confirm = {})
        options.confirm.delete !== undefined ||
            (options.confirm.delete = true)
        options.callbacks !== undefined || (options.callbacks = {})
        options.callbacks.onload !== undefined ||
            (options.callbacks.onload = null)
        options.callbacks.onadd !== undefined ||
            (options.callbacks.onadd = null)
        options.callbacks.onselector !== undefined ||
            (options.callbacks.onselector = null)
        options.callbacks.onchange !== undefined ||
            (options.callbacks.onchange = null)
        options.callbacks.onhover !== undefined ||
            (options.callbacks.onhover = null)
        options.callbacks.onfocus !== undefined ||
            (options.callbacks.onfocus = null)
        options.callbacks.ondelete !== undefined ||
    ...
    BBoxAnnotator.prototype.create_annotator_elements = function (
        url,
    ) {
        var bba, debug_style
        ...
        this.elements.frame = $(
            '<div class="ia-bbox-annotator-frame"></div>',
        )
        ...
        this.elements.image.onerror = function () {
            console.log.text(
                '[BBoxAnnotator] Invalid image URL provided: ' +
                    this.url,
            )
        }
    }

    BBoxAnnotator.prototype.delete_entry_interaction = function (
        event,
        index,
    ) {
        var bba = this
        ...
        if (event.shiftKey && entry.parent == null) {
            if (this.options.confirm.delete) {
                response = confirm(
                    'Are you sure you want to delete all sub-entries?',
                )
                if (!response) {
                    return
                }
            ...
            for (
                var index_entry = 0;
                index_entry < bba.entries.length;
                index_entry++
            ) {
                var parent
    ...
    BBoxAnnotator.prototype.register_global_key_bindings = function (
        selector,
        options,
    ) {
        var bba
            ...
            if (bba.options.hotkeys.enabled) {
                ...
                if (bba.options.hotkeys.delete.indexOf(key) != -1) {
                    ...
                    if (bba.state.mode == 'selector') {
                        ...
                        if (
                            bba.state.hover == null ||
                            bba.state.hover == bba.state.focus
                        ) {
                ...
                if (
                    bba.state.focus == null ||
                    bba.state.focus != bba.state.hover
                ) {
                    // Movement arrow keys for hovered bbox movement
                    hotkeys_movement = []
                    hotkeys_movement = hotkeys_movement.concat(
                        bba.options.hotkeys.up,
                    )
                    hotkeys_movement = hotkeys_movement.concat(
                        bba.options.hotkeys.down,
                    )
                    hotkeys_movement = hotkeys_movement.concat(
                        bba.options.hotkeys.left,
                    )
                    hotkeys_movement = hotkeys_movement.concat(
                        bba.options.hotkeys.right,
                    )
                    if (hotkeys_movement.indexOf(key) != -1) {
                        ...
                        if (
                            bba.options.hotkeys.left.indexOf(key) !=
                            -1
                        ) {
                            // Left arrow
                            correction.x = -1.0
                        ...
                        if (
                            bba.options.hotkeys.up.indexOf(key) != -1
                        ) {
                            // Up arrow
                            correction.y = -1.0
                        }
                        if (
                            bba.options.hotkeys.right.indexOf(key) !=
                            -1
                        ) {
                            // Right arrow
                            correction.x = 1.0
                        ...
                        if (
                            bba.options.hotkeys.down.indexOf(key) !=
                            -1
                        ) {
                            // Down arrow
                            correction.y = 1.0
                    ...
                    if (
                        bba.options.hotkeys.background.indexOf(key) !=
                        -1
                    ) {
                    ...
                    if (
                        bba.options.hotkeys.counterclockwise.indexOf(
                            key,
                        ) != -1
                    ) {
                    ...
                    if (
                        bba.options.hotkeys.clockwise.indexOf(key) !=
                        -1
                    ) {
    ...
    BBoxAnnotator.prototype.register_global_event_bindings = function (
        selector,
        options,
    ) {
        var bba
            ...
            if (bba.state.mode == 'selector') {
                ...
                if (bba.state.which == 3) {
                    ...
                    if (
                        ...
                        bba.entries_style_transparent(
                            bba.options.colors.transparent,
                            bba.state.hover,
                        )
                        ...
                        if (entry.parent != null) {
                            element2 =
                                bba.elements.entries[entry.parent]
                            element2.bbox.css({
                                opacity: 1.0,
                            })
                        }
            ...
            if (event.which == 1) {
                if (bba.state.mode == 'free' && bba.state.inside) {
                    ...
                    if (bba.state.hover != null) {
                        entry = bba.entries[bba.state.hover]
                        element =
                            bba.elements.entries[bba.state.hover]
                        ...
                        if (
                            ...
                            if (
                                ...
                                if (bba.state.focus2 == null) {
                                    ...
                                    if (
                                        bba.options.handles.close
                                            .enabled
                                    ) {
                                        element.close.show()
                                    }
                                    if (
                                        bba.options.handles.rotate
                                            .enabled
                                    ) {
                                        element.rotate.show()
                                    }
                    ...
                    if (bba.state.hover != null) {
                        ...
                        if (
                            ...
                            for (var key in element.resize) {
                                if (
                                    bba.options.handles.resize.enabled
                                ) {
                                    element.resize[key].show()
                                }
                            }
    ...
    BBoxAnnotator.prototype.resize = function () {
        ...
        if (zoom) {
            ...
            var limit1 = this.options.limits.frame.width
            var limit2 = (this.options.limits.frame.height / h1) * w1
    ...
    BBoxAnnotator.prototype.delete_entry = function (
        index,
        parent_index,
    ) {
        ...
        for (
            var index_entry = 0;
            index_entry < this.entries.length;
            index_entry++
        ) {
            var parent
        ...
        for (
            ...
            parent = this.entries[index_entry].parent
            if (parent != null) {
                this.entries[index_entry].parent = indices.indexOf(
                    parent,
                )
            }
        }
    ...
    BBoxAnnotator.prototype.rotate_element = function (
        element,
        angle,
    ) {
        var css_rotate
    ...
    BBoxAnnotator.prototype.add_entry = function (entry, notify) {
        ...
        if (!invalid) {
            ...
            if (!invalid) {
                ...
                entry.pixels = {}
                entry.pixels.left =
                    (entry.percent.left / 100.0) * width
                entry.pixels.top =
                    (entry.percent.top / 100.0) * height
                entry.pixels.width =
                    (entry.percent.width / 100.0) * width
                entry.pixels.height =
                    (entry.percent.height / 100.0) * height
            } else {
                console.log(
                    '[BBoxAnnotator] Invalid entry provided: incomplete bounding box dimensions and/or angle',
                )
                console.log(entry)
                return
            }
            ...
            console.log(
                '[BBoxAnnotator] Invalid entry provided: no bounding box dimensions',
            )
            console.log(entry)
            return
        }
        ...
        element.bbox = $(
            '<div class="' + this.options.classes.bbox + '"></div>',
        )
        element.bbox.css({
            position: 'absolute',
        ...
        if (entry.parent != null) {
            ...
            element.assignment = $(
                '<div id="' +
                    this.options.classes.assignment +
                    '"></div>',
            )
            element.assignment.css({
                height: 0 + '%',
                'border-top':
                    '1px solid ' + this.options.border.color,
                position: 'absolute',
                'transform-origin': '0% 0%',
            })
        ...
        element.label = $(
            '<div class="' + this.options.classes.label + '"></div>',
        )
        element.label.css({
            overflow: 'visible',
        ...
        element.close = $(
            '<div class="' + this.options.classes.close + '"></div>',
        )
        element.close.css({
            position: 'absolute',
            top: '5px',
        ...
        css_margin = Math.floor(
            (this.options.handles.rotate.diameter + 2) * 0.5,
        )
        css_handles = {
            position: 'absolute',
            width: this.options.handles.rotate.diameter + 'px',
            ...
            cursor: 'pointer',
            'border-radius':
                this.options.handles.rotate.diameter + 'px',
            '-moz-border-radius':
                this.options.handles.rotate.diameter + 'px',
        ...
        element.rotate = $(
            '<div class="' + this.options.classes.rotate + '"></div>',
        )
        ...
        css_margin = Math.floor(
            (this.options.handles.resize.diameter + 2) * 0.5,
        )
        css_handles = {
            position: 'absolute',
            ...
            cursor: 'pointer',
            'border-radius':
                this.options.handles.resize.diameter + 'px',
            '-moz-border-radius':
                this.options.handles.resize.diameter + 'px',
            '-webkit-border-radius':
                this.options.handles.resize.diameter + 'px',
        ...
        for (var key in configurations) {
            handle = $(
                '<div id="' +
                    this.options.ids.resize +
                    '-' +
                    key +
                    '" class="' +
                    this.options.classes.resize +
                    '"></div>',
            )
    ...
    BBoxAnnotator.prototype.hover_entry = function (index) {
        ...
        if (this.state.focus == null) {
            ...
            if (index != null) {
                ...
                for (
                    var index = 0;
                    index < this.elements.entries.length;
                    index++
                ) {
            ...
            if (index != null) {
                ...
                for (
                    var index_entry = 0;
                    index_entry < this.elements.entries.length;
                    index_entry++
                ) {
        ...
        if (this.options.callbacks.onhover != null) {
            if (this.state.focus == null) {
                ...
                return this.options.callbacks.onhover(
                    this.state.hover,
                    entry,
                )
            } else {
            ...
            if (index != this.state.focus) {
                if (this.state.focus2 == null) {
                    ...
                    if (this.options.callbacks.onfocus != null) {
                        ...
                        return this.options.callbacks.onfocus(
                            this.state.focus2,
                            entry,
                        )
                    }
    ...
    BBoxAnnotator.prototype.label_entry = function (index, label) {
        ...
        if (entry.parent == null && entry.label != null) {
            ...
            entry.parent != null &&
            entry.metadata.type != null &&
            this.options.subentries.label
        ) {
    ...
    BBoxAnnotator.prototype.assignment_entry = function (index) {
        ...
        var width = this.elements.frame.width()
        var height = this.elements.frame.height()

        // Compute centers
        centers = {}
        centers.entry = {
            x:
                ((entry.percent.left + entry.percent.width * 0.5) /
                    100.0) *
                width,
            y:
                ((entry.percent.top + entry.percent.height * 0.5) /
                    100.0) *
                height,
        }
        centers.parent = {
            x:
                ((parent.percent.left + parent.percent.width * 0.5) /
                    100.0) *
                width,
            y:
                ((parent.percent.top + parent.percent.height * 0.5) /
                    100.0) *
                height,
        }
    ...
    BBoxAnnotator.prototype.move_entry = function (event) {
        ...
        offset = {
            x:
                event.pageX -
                offset.left -
                this.state.anchors.cursor.x,
            y: event.pageY - offset.top - this.state.anchors.cursor.y,
        }

        ;(entry.pixels.left =
            this.state.anchors.element.x + offset.x),
            (entry.pixels.top =
                this.state.anchors.element.y + offset.y),
            (width = this.elements.frame.width())
        height = this.elements.frame.height()
    ...
    BBoxAnnotator.prototype.move_entry_correction = function (
        event,
        correction,
    ) {
    ...
    BBoxAnnotator.prototype.rotate_entry = function (event) {
        ...
        center = {
            x:
                this.state.anchors.element.x +
                this.state.anchors.element.width * 0.5,
            y:
                this.state.anchors.element.y +
                this.state.anchors.element.height * 0.5,
        }
        cursor = {
            x: event.pageX - offset.left,
            y: event.pageY - offset.top,
    ...
    BBoxAnnotator.prototype.orient_entry = function (
        event,
        direction,
        index,
    ) {
    ...
    BBoxAnnotator.prototype.background_entry = function (
        event,
        index,
        subentry,
    ) {
        ...
        if (entry.parent == null) {
            ...
            if (indices.length > 1) {
                ...
                element_penultimate = this.elements.entries[
                    index_penultimate
                ]
    ...
    BBoxAnnotator.prototype.resize_start = function (
        resize_element,
        event,
    ) {
        ...
        // Get the orientation
        bba.state.orientation = Math.floor(
            entry.angles.theta / (Math.PI * 0.5),
        )
        ...
        if (border_side != null) {
            ...
            element.bbox.css(
                'border-top',
                bba.options.border.width +
                    'px solid' +
                    bba.options.colors.hover,
            )
            element.bbox.css(
                border_side,
                bba.options.border.width * 1.5 +
                    'px dotted ' +
                    bba.options.colors.hover,
            )
        }
    ...
    BBoxAnnotator.prototype.resize_entry = function (event) {
        ...
        components.x.hypo = Math.sqrt(
            Math.pow(components.x.x, 2) + Math.pow(components.x.y, 2),
        )
        if (components.x.x > 0) {
        ...
        components.y.hypo = Math.sqrt(
            Math.pow(components.y.x, 2) + Math.pow(components.y.y, 2),
        )
        if (components.y.y > 0) {
    ...
    BBoxAnnotator.prototype.selector_start = function (event) {
        ...
        if (
            this.state.focus == null &&
            this.options.actions.entry.addition == false
        ) {
            return
        }
        if (
            this.state.focus != null &&
            this.options.actions.subentry.addition == false
        ) {
            return
        }
        ...
        this.entries_style_transparent(
        ...
        var subentry = this.state.focus != null
    ...
    BBoxAnnotator.prototype.selector_finish = function (event) {
        ...
        if (this.state.mode == 'selector') {
            ...
            invalid =
                invalid ||
                data.pixels.width * data.pixels.height <=
                    this.options.limits.entry.area
            invalid =
                invalid ||
                data.pixels.width <= this.options.limits.entry.width
            invalid =
                invalid ||
                data.pixels.height <= this.options.limits.entry.height
    ...
    BBoxAnnotator.prototype.entries_style_transparent = function (
        opacity,
        skip,
    ) {
        var css_transparent
    ...
    BBoxAnnotator.prototype.update_subentries_assignments = function (
        assignments,
    ) {
    ...
    BBoxAnnotator.prototype.update_subentries_visible = function (
        visible,
    ) {
    ...
    BBoxAnnotator.prototype.update_subentries_options = function () {
        if (this.state.focus == null) {
            this.entries_style_visible()
            if (
                !this.options.subentries.visible &&
    ...
    BBoxAnnotator.prototype.entries_style_visible = function (skip) {
        ...
        for (
            ...
            if (index != skip) {
                ...
                if (
                    entry.parent == null ||
                    this.options.subentries.visible == true
                ) {
                    element.bbox.show()
                    // Set the assignment
                    if (element.assignment != null) {
    ...
    BBoxAnnotator.prototype.subentries_style_visible = function (
        parent,
    ) {
        var entry, element
        ...
        for (
            ...
            if (
                entry.parent == parent &&
                this.options.subentries.visible != false
            ) {
                element.bbox.show()
                // Set the assignment
                if (element.assignment != null) {
    ...
    BBoxAnnotator.prototype.entry_style_default = function (index) {
        ...
        // Update element CSS
        color_background = entry.highlighted
            ? this.options.colors.highlighted
            : this.options.colors.default
        element.bbox.css({
    ...
    BBoxAnnotator.prototype.register_entry_event_bindings = function (
        element,
    ) {
        var bba
        ...
        element.close.mouseup(function (event) {
            ...
            index = parent.prevAll('.' + bba.options.classes.bbox)
                .length
