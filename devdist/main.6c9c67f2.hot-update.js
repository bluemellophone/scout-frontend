...
var _excluded = ["distance", "latitude", "longitude", "gps", "onChange", "openCount"];
...
function PointDistanceMap(_ref) {
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_3__.useEffect)(function () {
    ...
    if (lat && lng) drawStuff(parseFloat(lat), parseFloat(lng));
  }, [gps]); // useEffect(
  //   () => {
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("996d13f3")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=main.6c9c67f2.hot-update.js.map