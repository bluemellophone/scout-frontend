...
/* harmony import */ var _code_node_modules_babel_preset_react_app_node_modules_babel_runtime_helpers_esm_typeof__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./node_modules/babel-preset-react-app/node_modules/@babel/runtime/helpers/esm/typeof */ "./node_modules/babel-preset-react-app/node_modules/@babel/runtime/helpers/esm/typeof.js");
...
/* harmony import */ var _constants_apiKeys__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../../constants/apiKeys */ "./src/constants/apiKeys.js");
...
var _excluded = ["distance", "gps", "onChange"];
...
function PointDistanceMap(_ref) {
  ...
  function draw(lat, lng) {
    ...
    console.log((0,_code_node_modules_babel_preset_react_app_node_modules_babel_runtime_helpers_esm_typeof__WEBPACK_IMPORTED_MODULE_1__.default)(lat), (0,_code_node_modules_babel_preset_react_app_node_modules_babel_runtime_helpers_esm_typeof__WEBPACK_IMPORTED_MODULE_1__.default)(lng));
    console.log('draw called with', lat, lng, mapsApi);
    var markerPosition = new mapsApi.LatLng(lat, lng);
    var circle = new mapsApi.Circle({
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_4__.useEffect)(function () {
    var lat = (0,lodash_es__WEBPACK_IMPORTED_MODULE_8__.default)(gps, '0');
    var lng = (0,lodash_es__WEBPACK_IMPORTED_MODULE_8__.default)(gps, '1');
    if (lat && lng) draw(parseFloat(lat), parseFloat(lng));
  }, [gps]);
  return (0,_emotion_core__WEBPACK_IMPORTED_MODULE_7__.jsx)("div", {
    style: {
      height: 400,
      width: 500,
      maxWidth: '100%',
  ...
  }, (0,_emotion_core__WEBPACK_IMPORTED_MODULE_7__.jsx)(google_map_react__WEBPACK_IMPORTED_MODULE_5__.default, (0,_code_node_modules_babel_preset_react_app_node_modules_babel_runtime_helpers_esm_extends__WEBPACK_IMPORTED_MODULE_0__.default)({
    bootstrapURLKeys: {
      key: _constants_apiKeys__WEBPACK_IMPORTED_MODULE_6__.googleMapsApiKey
    },
    defaultCenter: {
      lat: 0,
      lng: 0
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("7f97d6a6")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=main.5e2bdb2c.hot-update.js.map